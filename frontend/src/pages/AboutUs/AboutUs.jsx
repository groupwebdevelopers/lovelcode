    ...
    <>
      <div>
        ...
        <div className="all about-us container">
          ...
          <div className="thinking xl:flex md:flex md:flex-col md:items-center md:text-center xl:text-right xl:flex-row xl:items-center  gap-12 mb-[70px]">
            <div className="img">
              <img src="images/mainweb/3D/Sec7/three.png" alt="" className="md:max-w-[400px] " />
            </div>

            <div className="paragraph2 flex flex-col gap-2 ">
              <span className="text-main-green-web text-[16px] font-Ray-Bold mt-[20px] md:mt-[0px]">قصه اینجوری شد که</span>
              <h1 className="font-Ray-ExtraBold text-[30px]">فکر کردیم میتونیم دنیا رو عوض کنیم...</h1>
