  ...
  return (
    <div className=" w-auto h-[43rem] bg-gradient-to-l from-[#004EC2] to-[#8B18FF] flex flex-col items-center mt-20 mb-40 lg:px-36 px-16">
      <div className="w-full h-40 flex py-4 justify-center relative">
        ...
        <button className="flex absolute top-6 -left-10 lg:top-16 lg:left-10 items-center justify-center gap-2 w-24 h-10 lg:w-28 lg:h-12 bg-white rounded-xl font-Ray-Light text-sm text-main-dark-text-web">
