    ...
    <div className="bg-third-gray-text-web/20 py-14">
      <div className="container flex flex-col items-cente">
        ...
        <span className="text-main-green-web text-sm sm:text-base lg:text-lg font-Ray-Bold text-center mb-2">
          ...
          <span className="text-main-blue-web inline-block">لاول کد</span>
        </span>
        <div className="flex items-center gap-x-16 xl:gap-x-24 w-full">
          ...
          >
            <SwiperSlide className="flex items-center">
              <Link>
                <img
                  src="/images/mainweb/3D/Secs5/unique.png"
                  className="max-h-16 opacity-50 hover:opacity-100 transition-all"
                  alt=""
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="flex items-center">
              <Link>
                <img
                  src="/images/mainweb/3D/Secs5/Vector.png"
                  className="max-h-16 opacity-50 hover:opacity-100 transition-all"
                  alt=""
                />
              </Link>
            ...
            <SwiperSlide className="flex items-center">
              <Link>
                <img
                  src="/images/mainweb/3D/Secs5/greenweb.png"
                  className="max-h-16 opacity-50 hover:opacity-100 transition-all"
                  alt=""
                />
              </Link>
            ...
            <SwiperSlide className="flex items-center">
              <Link>
                <img
                  src="/images/mainweb/3D/Secs5/Elabord.png"
                  className="max-h-16 opacity-50 hover:opacity-100 transition-all"
                  alt=""
                />
              </Link>
