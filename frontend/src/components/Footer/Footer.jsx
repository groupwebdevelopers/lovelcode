            ...
            <div className="flex justify-center">
              <div className="1 flex flex-col  gap-6">
                ...
                <div className="font-Ray-Bold text-sm max-w-[249px] lg:max-w-[200px]">
                  <p>
                    ما یک آژانس دیجیتال مارکتینگ تمام خدمت هستیم که کلیه خدماتی
                    که کسب و کارشما، برای رشد در فضای دیجیتال به آنها نیاز دارد
                    را برنامه ریزی و اجرا میکنیم.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="4 flex flex-col gap-6 ">
                ...
                <ul className="lg:mr-4 font-Ray-Bold">
                  <li className="flex gap-2 items-center">
                    ...
                    <p>
                      تهران ، شهرک غرب , خیابان غرب , طبقه <span>3</span>، واحد{" "}
                      <span>303</span>
                    </p>
                  </li>
                  <li className="flex gap-2 items-center">
